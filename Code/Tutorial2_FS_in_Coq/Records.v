...
Check Run John.
Theorem RUN: Run John -> exists x: Ind, run x. cbv. intro.  decompose record John. decompose record H.   exists (x1 John). apply e0. Qed.
...
Theorem RUN1: Run1 John -> exists x: Ind, run x.  cbv. intro.
                                                  decompose record John. decompose record H. exists (x1 John). apply e3. Qed.                                                    Check man. 
...
Theorem BLACK: Black Man John-> exists x:Ind, black x.  cbv. decompose record John. intros. decompose record H. exists (x1 John). assumption. Qed.
Check Black.